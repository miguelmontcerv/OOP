...
public class Tamagochi extends JFrame  implements LeeRed {
	static String preguntas []= { "como te llamas?","donde vives?","cuantos años tienes?","cual es tu color favorito?"};
	static String respuestas []= {"tamahochito","en tu corazon","uno mas que tu","el de tus ojos"};
